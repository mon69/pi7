...
--
-- Host: localhost
-- Generation Time: May 31, 2013 at 04:52 AM
...
CREATE TABLE IF NOT EXISTS `cat_productos` (
  ...
  `txt_contenido` varchar(45) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `cat_productos` (`idProducto`, `txt_nombre`, `txt_contenido`, `txt_marca`, `txt_codigoBarras`) VALUES
(1, 'Coca cola', '600ml', 'Coca Cola', ''),
(2, 'Mirinda', '600ml', 'Pepsi', ''),
(7, 'ChocoX', 'chocolitros', 'Choco', '');
...
INSERT INTO `ctrl_clientes` (`idCliente`, `txt_nombre`, `lat`, `lng`, `idProductosFavoritos`, `fec_sigVenta`) VALUES
(1, 'Enrique', 19.261400834632674, -103.7222671508789, 0, NULL),
(4, 'Choco Amezcua xD', 19.270961644869896, -103.71488571166992, 0, NULL);
