...
<?=form_open("user/inventory/lotesEdit/{$id}")?>
<div class = 'row-fluid'>
	<div class = 'span4 offset1'>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-prepend">
					<span class="add-on"><i class="icon-user"></i></span>
					<?=form_input('num_cantidad', $lote->num_cantidad ," placeholder = '300' class = 'input-xxlarge' ")?>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-prepend">
					<span class="add-on"><i class="icon-user"></i></span>
					<?=form_input('fec_caducidad', $lote->fec_caducidad ," placeholder = '06-01-2014' id = 'fec_caducidad' class = 'input-xxlarge' ")?>
				</div>
			</div>
		</div>
