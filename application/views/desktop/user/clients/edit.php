		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-prepend">
					...
					<?=form_input('txt_nombre',$client->txt_nombre," placeholder = 'Nombre' class = 'input-xlarge' ")?>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-prepend">
					...
					<?=form_input('txt_telefono',$client->txt_telefono," placeholder = '3121273647' class = 'input-xlarge' maxlength='10' ")?>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-prepend">
					...
					<?=form_input('txt_correo',$client->txt_correo," placeholder = 'algo@dominio.com' class = 'input-xlarge' maxlength='50' ")?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-prepend">
					...
					<?=form_input('lat',$client->lat," placeholder = '19.256' class = 'input-small' ")?>
				</div>
			</div>
			<br/>
			...
			<div class="controls">
				<div class="input-prepend">
					<span class="add-on"><i class="icon-map-marker"></i></span>
					<?=form_input('lng',$client->lng," placeholder = '-103.546' class = 'input-small' ")?>
				</div>
			</div>
		</div>
		<br/>
